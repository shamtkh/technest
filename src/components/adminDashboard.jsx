...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      {modalOpen && (
        <div className="admin-modal-overlay fixed inset-0 z-[100] flex items-start justify-center overflow-hidden bg-ink/60 p-2 pt-4 sm:items-center sm:p-4 modal-overlay-enter" onClick={() => setModalOpen(false)}>
