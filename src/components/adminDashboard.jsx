...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      {modalOpen && (
        <div className="admin-modal-overlay fixed inset-x-0 bottom-0 top-[5.75rem] z-[100] flex items-start justify-center overflow-hidden bg-ink/60 p-2 pt-4 sm:inset-0 sm:items-center sm:p-4 modal-overlay-enter" onClick={() => setModalOpen(false)}>
          <div onClick={(e) => e.stopPropagation()} className="admin-product-modal mt-2 flex w-full max-w-2xl flex-col rounded-2xl bg-white p-5 modal-enter sm:mt-0 sm:p-7">
